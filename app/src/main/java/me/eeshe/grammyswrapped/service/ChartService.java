...
public class ChartService {
    ...
    public boolean generateUserVcTimeChart(
        ...
        addAnnotation(
                ...
                String.format("Total: %s",
                        TimeUtil.formatMilliseconds(userVoiceChatData.getVoiceChatTimeMillis())),
                SERIES_COLORS.get(0),
                0.005,
                0.01);
    ...
    private Map<LocalDate, Duration> fillMissingDates(
        ...
        ZoneId zoneId = TimeUtil.getZoneId();
        ...
        LOGGER.info(
                "Missing dates filled. Original size: " + originalData.size() + ", Filled size: " + filledData.size());
        return filledData;
    }
